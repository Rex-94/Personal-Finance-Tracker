...
function App() {
  ...
  useEffect(() => {
    fetch("https://personal-finance-tracker-1-nz7q.onrender.com/transactions")
      .then((res) => res.json())
      .then((data) => {
  ...
  const addTransaction = async (tx) => {
    try {
      const res = await fetch("https://personal-finance-tracker-1-nz7q.onrender.com/transactions", {
        method: "POST",
  ...
  const deleteTransaction = async (_id) => {
    try {
      await fetch(`https://personal-finance-tracker-1-nz7q.onrender.com/transactions/${_id}`, {
        method: "DELETE",
      });
